...
import ChartContainer, {ButtonType,} from "../../components/generic/charts/ChartContainer"
...
const TotalPS = (props: Props) => {
    ...
    const [buttons, setButtons] = useState<ButtonType[]>([
        ...
        {title: "Blockchains", name: "Blockchain", selected: true, tooltipId: "ps-blockchains",},
    ])
